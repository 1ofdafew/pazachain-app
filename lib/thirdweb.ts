...
// Contract addresses
export const PAZA_TOKEN_ADDRESS = process.env.NEXT_PUBLIC_PAZA_TOKEN_ADDRESS || "0x...";
export const PUSD_TOKEN_ADDRESS = process.env.NEXT_PUBLIC_PUSD_TOKEN_ADDRESS || "0x...";
export const SALE_CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_SALE_CONTRACT_ADDRESS || "0x...";
export const VESTING_CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_VESTING_CONTRACT_ADDRESS || "0x...";

export const MANAGED_ACCOUNT_FACTORY_ADDRESS = process.env.NEXT_PUBLIC_MANAGED_ACCOUNT_FACTORY_ADDRESS || "0x...";
...
export function formatTokenAmount(value: bigint, decimals: number, displayDecimals: number = 2): string {
